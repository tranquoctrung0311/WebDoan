<div class="container-fluid footer">
	<div class="row footer-content">
		...
		<div class="col-md-4 col-sm-12">
            <h5>LIÊN HỆ</h5>
            <hr style="width: 17%;">
			<p><i class="fas fa-phone"></i> Hotline:0364110248</p>
			<p><i class="fas fa-calendar"></i> (9h30 - 18h30 từ thứ 2 đến thứ 7)</p>
			<p><i class="fas fa-mail-bulk"></i> Email: muteam@gmail.com</p>
			<p><i class="fas fa-map-marker-alt"></i> Địa chỉ:175 An Dương Vương,Quận 5,HCM,VietNam</p>
			<a class="btn dx-inline" href="https://www.facebook.com/c7clothing3"><i class="fab fa-facebook"></i></a>
			<a class="btn dx-inline" href="https://www.instagram.com/three__clothing/"><i class="fab fa-instagram"></i></a>
		</div>
