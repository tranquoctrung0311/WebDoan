...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2023 at 08:24 PM
...
(14, 13, 47, 2, 0, 750000, 1500000),
(15, 13, 27, 8, 0, 700000, 5600000),
(16, 13, 6, 2, 0, 500000, 1000000);
...
CREATE TABLE `chuongtrinhgiamgia` (
  ...
  `TEN_CHUONG_TRINH` varchar(50) NOT NULL,
  `LOAI_CHUONG_TRINH` varchar(50) NOT NULL,
  `ND_GIAM_GIA` varchar(100) DEFAULT NULL,
...
(1, 'Săn Sale 5-5', 'Giảm Giá Sản Phẩm', 'Giảm 10% cho các Sản Phẩm Ra Mắt Trong Tháng 5', 0.1, '2023-11-01 00:00:00', '2023-11-30 00:00:00'),
(2, 'Sản Phẩm Biểu Tượng', 'Giảm Giá Sản Phẩm', 'Giảm Giá 20% cho các Sản Phẩm Giá Từ 750000 VNĐ khi khách hàng mua >= 3 sản phẩm ', 0.2, '2023-11-01 00:00:00', '2023-11-30 00:00:00');
...
(13, NULL, 5, 'Linh Trung, Thu Duc, HCM', '0364110248', 0, 8100000, '2023-11-02 02:01:40');
...
(5, 6, 'Ha Van Dat', '20521166@gm.uit.edu.vn', '0364110248', 'Nam', 'Linh Trung, Thu Duc, HCM');
...
(1, 1, '2023-11-06', 60000000),
(2, 1, '2023-11-06', 10000000),
(3, 1, '2023-11-06', 2050000),
(4, 1, '2023-11-08', 750000000),
(5, 1, '2023-11-08', 750000000);
...
(6, 'Aniversary Big Logo', 78, 500000, 'Tee', 'L', 'Kỷ Niệm 3 năm thành lập Three Clothing', 'aniversary02.jpg'),
(7, 'HappyAniversary Special Fire', 39, 600000, 'Tee', 'S', 'Kỷ Niệm 3 năm thành lập Three Clothing', 'aniversary03.jpg'),
(8, 'HappyAniversary Special Fire', 39, 600000, 'Tee', 'M', 'Kỷ Niệm 3 năm thành lập Three Clothing', 'aniversary03.jpg'),
...
(25, 'ANGLES-RAINBOW', 98, 700000, 'Hoodie', 'S', 'Không Mua Bây Giờ Thì Mua Bao Giờ!!!', 'Hoodies-Angles.jpg'),
(26, 'ANGLES-RAINBOW', 100, 700000, 'Hoodie', 'M', 'Không Mua Bây Giờ Thì Mua Bao Giờ!!!', 'Hoodies-Angles.jpg'),
(27, 'ANGLES-RAINBOW', 89, 700000, 'Hoodie', 'L', 'Không Mua Bây Giờ Thì Mua Bao Giờ!!!', 'Hoodies-Angles.jpg'),
...
(47, 'Prive-Monogram-Cardigan', 36, 750000, 'Sweatshirt', 'M', 'Tái hiện cảm xúc của một kỳ nghỉ mát ngoài trời, \"Les Vacances\" mang đến những màu sắc mới tượng trưng cho màu của thiên nhiên: Màu xanh lá (Deep Green) của cây cỏ, màu nâu (Brown) của mùa thu, màu hồng cam (Living Coral) của những bông hoa dưới ánh mặt trời. Những gam màu này được kết hợp uyển chuyển với gam màu chủ đạo của Privé, tạo nên những phối màu sang trọng và trẻ trung, giúp cho kỳ nghỉ mát của bạn trở nên rực rỡ hơn bao giờ hết. \r\nĐược thiết kế dành cho những hoạt động ngoài trời, chất liệu chủ đạo của BST – len Rayon – luôn đảm bảo sự thoáng mát và thoải mái cho người mặc. Ngoài ra, sự đa dạng về kiểu dáng sản phẩm cũng giúp người mặc có nhiều lựa chọn hơn về phong cách để phù hợp nhất với mỗi chuyến đi của mình.', 'Prive-Monogram-Cardigan.jpg'),
(48, 'Prive-Monogram-Cardigan', 39, 750000, 'Sweatshirt', 'L', 'Tái hiện cảm xúc của một kỳ nghỉ mát ngoài trời, \"Les Vacances\" mang đến những màu sắc mới tượng trưng cho màu của thiên nhiên: Màu xanh lá (Deep Green) của cây cỏ, màu nâu (Brown) của mùa thu, màu hồng cam (Living Coral) của những bông hoa dưới ánh mặt trời. Những gam màu này được kết hợp uyển chuyển với gam màu chủ đạo của Privé, tạo nên những phối màu sang trọng và trẻ trung, giúp cho kỳ nghỉ mát của bạn trở nên rực rỡ hơn bao giờ hết. \r\nĐược thiết kế dành cho những hoạt động ngoài trời, chất liệu chủ đạo của BST – len Rayon – luôn đảm bảo sự thoáng mát và thoải mái cho người mặc. Ngoài ra, sự đa dạng về kiểu dáng sản phẩm cũng giúp người mặc có nhiều lựa chọn hơn về phong cách để phù hợp nhất với mỗi chuyến đi của mình.', 'Prive-Monogram-Cardigan.jpg'),
...
(87, 'Áo polo trắng', 50, 300000, 'Tee', 'S', 'Kỷ niệm trung thu', '06d0a6a10b56e1bc3fe1d25b1b039248.jpg');
...
(1, 1, 'admin', 'admin', 1, ''),
(2, 3, 'Nguyen Van Dat', '123456789', 1, 'nguyenvandat@gmail.com'),
(6, 3, 'Ha Van Dat', '25f9e794323b453885f5181f1b624d0b', 1, '20521166@gm.uit.edu.vn'),
(7, 2, 'Hà Văn Đạt', '123456789', 1, 'havandat768@gmail.com');
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `MA_CTHD` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `chitietphieunhap`
--
ALTER TABLE `chitietphieunhap`
  MODIFY `MA_CTPN` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
...
--
ALTER TABLE `hoadon`
  MODIFY `MA_HD` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `sanpham`
  MODIFY `MA_SP` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
